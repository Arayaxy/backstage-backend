...
import { healthRouter, authRouter, clienteRouter, espacioRouter, eventoRouter, ponenteRouter, uploadRouter } from './routes/index.js';
...
app.use(`${env.apiUrl}/espacios`, espacioRouter);
